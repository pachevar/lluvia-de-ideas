...
export const DEFAULT_CONFIG: PortalConfig = {
  ...
  pozoIdeas: {
    intro: "La Gran Galería es el banco central de proyectos, retos y propuestas pedagógicas para el Ecosistema Sutz.",
    ideas: [
      {
        id: "idea-1",
        ...
        targetAge: "10-15 años",
        notes: "Integrar con el generador de la Máquina de Cuentos."
      },
      {
        id: "idea-2",
        title: "Simulador de Órbitas Keplerianas Avanzado",
        description: "Expansión del Sistema Solar 3D con cálculo gravitacional en tiempo real.",
        category: "100tek",
        status: "semilla",
        tags: ["Ciencia", "Astronomía", "Física", "3D"],
        targetAudience: "Estudiantes de Ciclo Básico y Diversificado",
        targetAge: "12-18 años",
        notes: "Uso de Three.js y shaders personalizados."
      },
      {
        id: "idea-3",
        title: "Pabellón de Realidad Aumentada Popol Vuh",
        description: "Visualización de seres mitológicos mayas en 3D sobre marcadores impresos.",
        category: "sutz",
        status: "semilla",
        tags: ["RA", "Cultura", "Mito", "Interactividad"],
        targetAudience: "Toda la comunidad educativa",
        targetAge: "Todas las edades",
        notes: "Revisar compatibilidad con WebXR en móviles."
      },
      {
        id: "idea-4",
        title: "Expansión de Biomas Subterráneos de Xibalbá",
